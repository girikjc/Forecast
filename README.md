Forecast app with Architecture Components
==========================================
## About
This app is for the Advanced Android Development
...
All classes related to caching the data locally 
...
### `utilities` package
* `SunshineDateUtils` -  Utility methods for normalizing dates across time zones; this helps us to "round" to the nearest date, so that when we sore a date in the database, it always refers to that date at 12:00am, GMT.
...
### AppExectuors class
This class provides a global executor pool. [here](https://www.youtube.com/watch?v=uCmHoEY1iTM). In short, this class provides an easy and efficient way to run code off of the main thread.
